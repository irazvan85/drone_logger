...
- [x] T039b [US1] Write test to verify original files are preserved (read-only access) in `backend/tests/unit/test_photo_processor.py`
...
- [x] T041b [US1] Implement duplicate photo detection logic (hash/metadata check) in `backend/src/services/photo_processor.py`
...
- [x] T077 [US2] Write E2E test for map marker interaction in `frontend/tests/e2e/marker-interaction.spec.ts`
